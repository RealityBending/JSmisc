...
jsPsych.plugins["image-keyboardmouse-response"] = (function () {

  var plugin = {}

  jsPsych.pluginAPI.registerPreload('image-keyboardmouse-response', 'stimulus', 'image')

  plugin.info = {
    name: 'image-keyboardmouse-response',
    description: '',
    parameters: {
      stimulus: {
